    ...
    <div style={{ backgroundColor: "#E5E5E5" }}>
      ...
      >
        <div style={{ width: "25%", minWidth: 300, marginTop: 20 }}>
          ...
          >
            <div>
              <span style={{ fontWeight: 600 }}>Instagram:</span> www.link.com
            </div>
            <div>
            ...
            <div>
              <span style={{ fontWeight: 600 }}>Apple music:</span> www.link.com
            </div>
          </div>
          <div
            className="divShadow"
      ...
      <div
        style={{ backgroundColor: "#ffffff", padding: 40, marginBottom: 20 }}
      >
      ...
      >
        ...
        <Container style={{ fontSize: 18, overflowX: "scroll" }}>
          <Row
            style={{ marginBottom: 30, color: "#B7B7B7", flexWrap: "nowrap" }}
          >
            <Col xs="1"></Col>
          ...
          {[
            ...
            >
              ...
              <Col xs="6" style={{ minWidth: 180 }}>
                <div>{rep.name}</div>
                <div style={{ fontSize: 13, color: "#CB0086" }}>{rep.link}</div>
              </Col>
              <Col xs="3" style={{ textAlign: "center", minWidth: 150 }}>
                <Badge
                  style={{
